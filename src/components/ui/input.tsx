    ...
    return (
      <div
        className={cn(
          ...
          !addon?.left ? "data-[size=default]:pl-2 data-[size=sm]:pl-1.5 data-[size=lg]:pl-3" : "",
          !addon?.right ? "data-[size=default]:pr-2 data-[size=sm]:pr-1.5 data-[size=lg]:pr-3" : ""
        )}
        data-state={state}
      ...
      >
        {addon?.left && (
          <div
            ...
            style={{
              background: `hsl(var(--${addon.background ?? "muted"}))`,
              color: `hsl(var(--${addon.background ?? "muted"}-foreground))`,
            }}
          >
            {addon.left}
          </div>
        ...
        <div className="inline-flex items-center">
          {type === "password" && (
            ...
            >
              {!revealPassword ? <Eye className="!size-3.5" /> : <EyeClosed className="!size-3.5" />}
            </Button>
          )}
          {onClearValue && (
            <Button className={cn("h-6 w-6 p-0")} variant={"ghost"} onClick={onClearValue}>
